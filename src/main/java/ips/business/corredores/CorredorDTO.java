...
public class CorredorDTO {
    ...
    private String getCategoríaEdad(Date edadDate) { // [ADRI] Método auxiliar lo dejé aquí, luego hacer clase
						     // inscripcion y
	// esa tiene un método que recibe lo mismo que getCategoria y devuelve sus
	// propias categorias?
	...
	int edad = Period.between(LocalDate.of(calendar1.get(Calendar.YEAR), calendar1.get(Calendar.MONTH) + 1,
		calendar1.get(Calendar.DAY_OF_MONTH)), LocalDate.now()).getYears();
