...
//	}
	...
	private JPanel getPn_EdadInicio() {
		if (pn_EdadInicio == null) {
			...
			pn_EdadInicio.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Edad inicio", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
	...
	private JPanel getPn_EdadFin() {
		if (pn_EdadFin == null) {
			...
			pn_EdadFin.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Edad fin", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
	...
	private JPanel getPn_Sexo() {
		if (pn_Sexo == null) {
			pn_Sexo = new JPanel();
			pn_Sexo.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Sexo", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
